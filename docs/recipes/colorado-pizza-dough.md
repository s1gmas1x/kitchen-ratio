...
When I worked at Fargo’s Pizza Co., I didn’t have access to the exact formula, but I worked with the dough every day for nearly 20 years. This recipe is based on that experience, along with a few adjustments I’ve always felt improved it.

The original dough used a slightly **lower hydration**, which worked well with a commercial dough sheeter. For home baking, increasing hydration improves:

- Extensibility  
- Handling (without a sheeter)  
- Crust texture - lighter, less dense, and more open

If you want something closer to the restaurant version, simply reduce the hydration.  
...
- If using active dry yeast add to water for about 10 minutes before adding the rest of the ingredients.  
...
### 3. Final Proof
- Divide and shape into dough balls. Streching the balls against the counter to tighten.
...
### 4. Shaping
- Allow the dough balls to warm before shaping. Remove from refigeration for 1-2 hours.  

...
head:
  - - meta
    - name: description
      content: A practical reconstruction of a family Swedish rye bread, built around a hot rye scald and sized for modern home baking.
  - - meta
    - property: og:title
      content: Grandma's Swedish Rye
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://kitchenratio.com/recipes/grandmas-swedish-rye.html
  ...
  - - link
    - rel: canonical
      href: https://kitchenratio.com/recipes/grandmas-swedish-rye.html
---

# Grandma's Swedish Rye
...
<div class="recipe-glance">
  <div class="recipe-glance-card">
    <strong>Style</strong>
    <span>Soft pan rye with a hot flour scald, mild sweetness, and everyday sandwich use in mind.</span>
  </div>
  <div class="recipe-glance-card">
    <strong>Yield</strong>
  ...
  <div class="recipe-glance-card">
    ...
    <span>Home bakers who want a practical starting point for a family-style Scandinavian rye loaf.</span>
  </div>
</div>
...
Let the bread cool completely, then keep it wrapped or bagged at room temperature for several days.
This style usually slices best after it has fully cooled and often tastes even better the next day.

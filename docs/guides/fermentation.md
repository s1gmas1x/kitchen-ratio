---
title: Fermentation
description: "Practical fermentation workflow for dough: timing, temperature, signs of readiness, and common fixes."

head:
  - - meta
    - name: description
      content: "Practical fermentation workflow for dough: timing, temperature, signs of readiness, and common fixes."
  - - meta
    - property: og:title
  ...
  - - meta
    - property: og:url
      content: https://kitchenratio.com/guides/fermentation.html
  ...
  - - link
    - rel: canonical
      href: https://kitchenratio.com/guides/fermentation.html
---
...
1. Mix dough until evenly hydrated.
2. Ferment in bulk (room or cold, depending on style).
3. Add folds early if dough needs strength.
4. Stop bulk when dough is visibly aerated and alive, not collapsed.

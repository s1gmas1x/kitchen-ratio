---
title: Yield Planner
description: Use the Yield Planner to size pieces by count or grams, and estimate batch yield.

head:
  - - meta
    - name: description
      content: Use the Yield Planner to size pieces by count or grams, and estimate batch yield.
  - - meta
    - property: og:title
      content: Yield Planner
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://kitchenratio.com/guides/yield-planner.html
  ...
  - - link
    - rel: canonical
      href: https://kitchenratio.com/guides/yield-planner.html
---

...
Yeast is the engine in the dough: it makes gas, builds pressure, and drives fermentation flavor.
Different yeast types behave differently, but each one can produce excellent bread when handled correctly.
